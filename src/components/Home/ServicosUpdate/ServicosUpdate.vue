<template>
  <div class="container">
    ...
    <div class="form-div">
      <form
        class="form"
        @submit.prevent="postServico(service_id, client_id, servico, status, data, horario)"
      >
        ...
        <div v-if="success == true" class="succes">Serviço Atualizado</div>
        <div v-if="fail == true" class="error">ID's incorretos</div>
      </form>
    </div>
  </div>
</template>
