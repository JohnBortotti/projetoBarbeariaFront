<template>
  <div class="container">
    ...
    >Voltar</button>
    <h3 class="title">Atualizar Cliente</h3>
    <div class="form-div">
      <form class="form" @submit.prevent="updateClient(client_id, name, phone, email)">
        ...
        <div class="form-input">
          <label>Email</label>
          <input class="form-input" v-model="email" placeholder="insira o email" required />
        </div>
